...
const AddDataTakmirMasjid = ({title}) => {
  const [NAMA_MASJID, setNamaMasjid] = useState("");
  const [NAMA_KETUA_TAKMIR, setNamaKetua] = useState("");
  ...
  const handleSave = async (e) => {
    ...
    try {
      await axios
        .post(`http://127.0.0.1:3000/members/saveTakmirMasjid`, {
          KECAMATAN,
          KELURAHAN,
          NAMA_MASJID,
          RT,
        ...
        <div className="flex flex-col w-full h-full gap-7">
          <div>
            <div className="space-y-7 h-5/6 flex flex-col">
              ...
              <div className="flex flex-col">
                <label htmlFor="inputNama">Nama Ketua Takmir</label>
                <input
                  type="text"
                  id="inputNama"
              ...
              <div className="flex flex-col">
                <label htmlFor="inputJamaah">Nama Masjid</label>
                <input
                  type="text"
                  id="inputJamaah"
                  value={NAMA_MASJID}
...
export default AddDataTakmirMasjid
