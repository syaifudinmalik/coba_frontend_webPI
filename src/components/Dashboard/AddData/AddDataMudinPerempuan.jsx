...
const AddDataMudinPerempuan = ({ title }) => {
  ...
  const handleSave = async (e) => {
    ...
    try {
      await axios
        .post(`http://127.0.0.1:3000/members/saveMudinPerempuan`, {
          KECAMATAN,
          KELURAHAN,
          RT,
          RW,
        ...
        <div className="flex flex-col w-full h-full gap-7">
          <div>
            <div className="space-y-7 h-5/6 flex flex-col">
              ...
              <div className="flex flex-col">
                <label htmlFor="inputNama">Nama Mudin</label>
                <input
                  type="text"
                  id="inputNama"
                  value={NAMA}
...
export default AddDataMudinPerempuan;
