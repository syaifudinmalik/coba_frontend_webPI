...
const AddDataGuruKeagamaan = ({ title }) => {
  const [NAMA_LEMBAGA, setNamaJamaah] = useState("");
  ...
  const handleSave = async (e) => {
    ...
    try {
      await axios
        .post(`http://127.0.0.1:3000/members/saveGuruKeagamaan`, {
          KECAMATAN,
          KELURAHAN,
          DUSUN,
          RT,
        ...
        <div className="flex flex-col w-full h-full gap-7">
          <div>
            <div className="space-y-7 h-5/6 flex flex-col">
              ...
              <div className="flex flex-col">
                <label htmlFor="inputJamaah">Nama Lembaga</label>
                <input
                  type="text"
                  id="inputJamaah"
                  value={NAMA_LEMBAGA}
...
export default AddDataGuruKeagamaan;
